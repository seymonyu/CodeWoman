...
class SelectHero extends Component {
  ...
  handlerOnClickMale () {
    this.setState({mountMaleComp:true})
  ...
  render() {
    return (
      <div>
        {this.state.mountMaleComp === true? <ChooseMale /> : null}
        <img src= "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909__340.png" alt="place holder" onClick={this.state.mountMaleComp}/>
